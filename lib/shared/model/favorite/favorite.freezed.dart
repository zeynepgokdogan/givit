...
abstract class $FavoriteCopyWith<$Res> {
  ...
  @useResult
  $Res call({String userId, Product product});
...
class _$FavoriteImpl implements _Favorite {
  _$FavoriteImpl({required this.userId, required this.product});
  ...
  @override
  String toString() {
    return 'Favorite(userId: $userId, product: $product)';
  }
  ...
  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, userId, product);
...
abstract class _Favorite implements Favorite {
  factory _Favorite(
      ...
      required final Product product}) = _$FavoriteImpl;
